            ...
            if ($count == 0) {
                ...
                if (! empty($radio_options)) {
                  ...
                  $this->__createPermissionIfNotExists($permissions);
                    ...
                    } elseif ($role_name_lower == 'cashier') {
                        $permissions = array_merge($permissions, [
                            'notification.booking', 
                            'notification.customer'
                        ]);
                    } elseif ($role_name_lower == 'stock') {
                        $permissions = array_merge($permissions, [
                            'notification.stock'
                        ]);
                    }
...
$role_name_lower = strtolower(str_replace('#'.$business_id, '', $role->name));

if ($role_name_lower == 'admin') {
    $role_permissions = array_merge($role_permissions, [
        'notification.all', 
        'notification.booking', 
        'notification.customer', 
        'notification.stock'
