...
class Product extends Model
{
    ...
    /**
     * Get sub-sub-category associated with the product.
     */
    public function sub_sub_category()
    {
        return $this->belongsTo(\App\Category::class, 'sub_sub_category_id', 'id');
    }

    /**
     * Get sub-sub-sub-category associated with the product.
     */
    public function sub_sub_sub_category()
    {
        return $this->belongsTo(\App\Category::class, 'sub_sub_sub_category_id', 'id');
    }
    ...
    /**
     * Get compatibility records associated with the product.
     */
    public function compatibility()
    {
        return $this->hasMany(\App\ProductCompatibility::class);
    }
}
