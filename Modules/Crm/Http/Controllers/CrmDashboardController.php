...
class CrmDashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        // Smart Maintenance Prediction stats
        $prediction_stats = ServicePrediction::where('business_id', $business_id)
            ->select(
