        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav d-block">
                    ...
                    @endcan
                    <li @if(request()->segment(2) == 'service-predictions') class="active" @endif>
                        <a href="{{action([\Modules\Crm\Http\Controllers\ServicePredictionController::class, 'index'])}}">
                            <i class="fas fa-chart-line"></i> توقعات الصيانة
                        </a>
                    </li>
