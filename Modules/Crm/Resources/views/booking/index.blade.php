...
@section('content')
    ...
    <section class="content-header">
        <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang('restaurant.bookings')</h1>
        <!-- <ol class="breadcrumb">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-12">
                                <button type="button" class="btn btn-primary pull-right" id="add_new_booking_btn"><i
...
@section('javascript')
    ...
    <script type="text/javascript">
        $('#gehad_category_id').on('change', function() {
            ...
            //alert(brandId);
            $.ajax({
                url: '/contact/bookings/get-models/' + brandId, // Your route for fetching models
                type: 'GET',
        ...
        $(document).ready(function() {
            ...
            //     format: 'YYYY-MM-DD HH:mm:ss', // Adjust format as needed (e.g., 'hh:mm A' for AM/PM)
            //     useCurrent: false
            // });
