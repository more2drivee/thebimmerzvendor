...
@section('content')
    ...
    <section class="content no-print">
        ...
        {{-- Smart Maintenance Prediction Widget --}}
        @if(!empty($prediction_stats))
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools">
                            <a href="{{ action([\Modules\Crm\Http\Controllers\ServicePredictionController::class, 'index']) }}" class="btn btn-sm btn-primary">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="info-box">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number">{{ $prediction_stats->on_time_count ?? 0 }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-6">
                                <div class="info-box">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-text">مستحق</span>
                                        <span class="info-box-number">{{ $prediction_stats->due_count ?? 0 }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-6">
                                <div class="info-box">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number">{{ $prediction_stats->overdue_count ?? 0 }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-6">
                                <div class="info-box">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-text">خطر عالي</span>
                                        <span class="info-box-number">{{ $prediction_stats->high_risk_count ?? 0 }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
