    ...
    <div class="page-shell">
        <div class="hero">
            <div class="hero-card">
                <div class="brand-mark">
                    ...
                    <div>
                        <div class="brand-survey">{{ optional($survey->first())->title }}</div>
                        <p class="brand-desc">{{ optional($survey->first())->description }}</p>
                        <div class="tagline">مرحبا {{ $user->name }} — ملاحظاتك تساعدنا على تحسين خدماتنا.</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="form-shell">
            ...
            <form method="POST" action="/thanks">
                @csrf
                <input type="hidden" name="surveyId" id="surveyId" value="{{ optional($survey->first())->id }}">
                <input type="hidden" name="user_id" id="user_id" value="{{ $user->id }}">
                <input type="hidden" name="action_id" id="action_id" value="{{ $action->id }}">
                <input type="hidden" name="old_survey_id" id="old_survey_id" value="{{ optional($survey->first())->id }}">
                    ...
                    <div class="question-card">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div>
                                ...
                                @elseif($q->type_id == 5)
                                    <div class="helper">اختر إعجاب أو عدم إعجاب</div>
                                @elseif($q->type_id == 2)
