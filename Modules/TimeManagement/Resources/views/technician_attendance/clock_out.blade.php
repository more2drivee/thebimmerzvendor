@extends('layouts.app')
@section('title', __('timemanagement::technician_attendance.clock_out_technician'))

@section('content')
@include('timemanagement::partials.nav')

<section class="content-header">
    <h1>@lang('timemanagement::technician_attendance.clock_out_technician')</h1>
</section>
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="box box-danger">
                <div class="box-header with-border">
                    <h3 class="box-title">@lang('timemanagement::technician_attendance.clock_out_form')</h3>
                    <div class="box-tools">
                ...
                <form method="POST" action="{{ route('timemanagement.clock_out') }}">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="clock_out_time">@lang('timemanagement::technician_attendance.clock_out_time')</label>
                            <input type="datetime-local" name="clock_out_time" id="clock_out_time" class="form-control" value="{{ old('clock_out_time', date('Y-m-d\TH:i')) }}">
                    ...
                    <div class="box-footer">
                        <button type="submit" class="btn btn-danger">@lang('timemanagement::technician_attendance.clock_out')</button>
