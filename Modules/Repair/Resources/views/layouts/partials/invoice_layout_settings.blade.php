...
@php
	$default = [
		...
		'show_brand' => 1,
		'brand_label' => 'Brand',
		'show_jobsheet_details' => 1,
		'jobsheet_label' => 'JobSheet Details',
	];
	...
	if(!empty($edit_il)){
		$default = [
			...
			'show_jobsheet_details' => !empty($module_info['repair']['show_jobsheet_details']) ? 1 : 0,
			'jobsheet_label' =>  !empty($module_info['repair']['jobsheet_label']) ? $module_info['repair']['jobsheet_label'] : '',
		];
	}
       ...
       <div class="col-sm-3">
		...
		<div class="col-sm-3">
			<div class="form-group">
				<div class="checkbox">
					<label>
						{!! Form::checkbox('module_info[repair][show_jobsheet_details]', 1, $default['show_jobsheet_details'], ['class' => 'input-icheck']); !!} @lang('repair::lang.show_jobsheet_details')
					</label>
				</div>
			</div>
		</div>
		<div class="col-sm-3">
			<div class="form-group">
				{!! Form::label('module_info[repair][jobsheet_label]', __('repair::lang.jobsheet_label') . ':' ) !!}
				{!! Form::text('module_info[repair][jobsheet_label]', $default['jobsheet_label'], ['class' => 'form-control', 'placeholder' => __('repair::lang.jobsheet_label') ]); !!}
			</div>
		</div>
    @endcomponent

	@include('repair::layouts.partials.jobsheet_invoice_fields')
@endif