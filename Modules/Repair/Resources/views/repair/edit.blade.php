...
<div class="alert alert-danger">
    ...
    <strong>{{ __('repair::lang.sell_return_warning') }}</strong>
    {{ __('repair::lang.sell_return_edit_note') }}
    <span class="pull-right"><strong>{{ __('repair::lang.return_amount') }}:</strong> <span class="display_currency" data-currency_symbol="true">{{ $transaction->return_parent->final_total }}</span></span>
</div>
@endif
