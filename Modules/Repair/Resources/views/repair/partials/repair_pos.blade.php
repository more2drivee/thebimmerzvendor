@php
	...
	if (!empty($view_data['job_sheet'])) {
		...
		$repair['repair_device_km'] = $view_data['job_sheet']['repair_device_km'] ?? null;
		...
		$repair['repair_device_km'] = $transaction['repair_device_km'] ?? null;
	}
...
<div class="row">
	...
	<div class="col-sm-4">
		<div class="form-group">
			{!! Form::label('repair_device_km', __('repair::lang.device_km') . ':') !!}
			{!! Form::text('repair_device_km', !empty($repair['repair_device_km']) ? $repair['repair_device_km'] : null, ['class' => 'form-control', 'placeholder' => __('repair::lang.device_km')]); !!}
		</div>
	</div>
