  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    {!! Form::label('status_category', __( 'Status Category' ) . ':') !!}
                    {!! Form::select('status_category', ['status' => 'Status', 'note' => 'Note'], null, ['class' => 'form-control', 'placeholder' => __( 'Status Category' )]) !!}
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    {!! Form::select('icon', [
                        ...
                        'fa-clock' => 'Clock',
                        'fa-times' => 'Cancel'
                    ], null, ['id' => 'icon-selector', 'class' => 'form-control', 'placeholder' => 'Select Icon']) !!}
