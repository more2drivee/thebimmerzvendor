...
return [
    ...
    'select_location_on_map' => 'Click on the map to select location, or drag the marker to adjust',
    'clear' => 'Clear',
    ...
    'enable_sub_sub_category' => 'Enable Category 3 & 4',
    ...
    'required_payment_account_balance_not_available' => 'Insufficient payment account balance',
    ...
    'waiting' => 'Waiting',
    'Request' => 'Request',
    'Product_Compatability' => 'Product Compatability',
    ...
    'received_qty_placeholder' => 'Leave empty to use quantity',
    ...
    'brands' => 'Brands',
    'models_and_years' => 'Models and Years',
    'vehicle_compatibility' => 'Vehicle Compatibility',
    'vehicle_compatibility_help' => 'Vehicle compatibility data is stored in the product_compatibility table',
    ...
    'add_another_model' => 'Add Another Model',
    'remove' => 'Remove',
    ...
    'product' => 'Product',
    'loyalty_requests' => 'Loyalty Requests',
    'points_requested' => 'Points Requested',
    'amount_discounted' => 'Amount Discounted',
    'approved_by' => 'Approved By',
    'confirm_approve_loyalty_request' => 'Are you sure you want to approve this loyalty request?',
    ...
    'no_compatibility_data' => 'compatibility data not found',
    'add_compatibility' => 'Add Compatibility',
    'data_permissions' => 'Data Permissions',
    'carservpro' => 'CarServPro',
    'carservpro_category' => 'CarServPro (By Category)',
    'carservpro_spare_parts' => 'Spare Parts',
    'carservpro_services' => 'Services',
    ...
    'quotation_note_placeholder' => 'Enter notes that will be visible to customer in the quotation',
    'internal_notes' => 'Internal Notes',
    'internal_notes_placeholder' => 'Enter internal notes for staff only (not visible to customer)',
    'include_availability_notes' => 'Include Availability Notes',
    'availability_notes' => 'Availability Notes',
    'availability_notes_placeholder' => 'Enter notes about part availability and potential delays',
    'send_sms_to_customer' => 'Send SMS to Customer',
    'job_estimator_created_message' => 'Job estimator created successfully',
    'job_estimator_sent_message' => 'Job estimator sent to customer',
    'job_estimator_approved_message' => 'Job estimator approved by customer',
    'created' => 'Created',
    ...
    'select_products_to_merge' => 'Select products to merge into the target product',
    'yes' => 'Yes',
    'no' => 'No',
    ...
    'recent_loyalty_requests' => 'Recent Loyalty Requests',
    ...
    'version_update_help_text' => 'Configure app version settings for mobile clients',
    'min_version_code' => 'Minimum Version Code',
    'min_version_code_help' => 'The minimum version required to run the app',
    'latest_version_code' => 'Latest Version Code',
    'latest_version_code_help' => 'The latest available version code',
    'latest_version_name' => 'Latest Version Name',
    'latest_version_name_help' => 'Display name for the latest version',
    'force_update' => 'Force Update',
    'force_update_help' => 'Require users to update to continue using the app',
    'apk_url' => 'APK Download URL',
    'apk_url_help' => 'URL to download the latest APK file',
    'update_message' => 'Update Message',
    'update_message_help' => 'Message to display to users when an update is available',
    'api_endpoints' => 'API Endpoints',
    'endpoint' => 'Endpoint',
    'method' => 'Method',
    'get_version_info_desc' => 'Get current version information',
    'check_update_desc' => 'Check if an update is required',
    'locations' => 'Locations',
    'inspection_service' => 'Inspection Service',
    
    // Social Login Settings
    'social_login_settings' => 'Social Login Settings',
    'social_login_settings_description' => 'Configure Google and Apple login for your mobile app',
    'google_login_settings' => 'Google Login Settings',
    'enable_google_login' => 'Enable Google Login',
    'google_client_id' => 'Google Client ID',
    'google_client_secret' => 'Google Client Secret',
    'apple_login_settings' => 'Apple Login Settings',
    'enable_apple_login' => 'Enable Apple Login',
    'apple_client_id' => 'Apple Client ID (Service ID)',
    'apple_client_id_help' => 'The Service ID (Identifier) from Apple Developer Console',
    'apple_team_id' => 'Apple Team ID',
    'apple_key_id' => 'Apple Key ID',
    'apple_redirect_url' => 'Apple Redirect URL',
    'apple_p8_file' => 'Apple Private Key (.p8 file)',
    'apple_p8_file_help' => 'Upload the .p8 private key file downloaded from Apple Developer Console',
    'current_file' => 'Current file',
    'note' => 'Note',
    'social_login_setup_instructions' => 'To enable social login: 1) Create OAuth apps in Google Console and Apple Developer Portal 2) Add your redirect URLs 3) Copy client credentials here 4) Upload Apple .p8 private key file',
];
