...
@section('title', __('product_extensions.title'))

@section('content')
<div class="content-wrapper">
    <section class="content-header">
        <h1>@lang('product_extensions.title')</h1>
    </section>
                        ...
                        <div class="card card-{{ $card['color'] }} card-outline h-100">
                            <div class="card-body text-center d-flex flex-column">
                                ...
                                <a href="{{ $card['route'] }}" class="btn btn-{{ $card['color'] }} btn-sm mt-auto">
                                    <i class="fas fa-arrow-right"></i> @lang('product_extensions.access')
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body text-center">
                        <h4>@lang('product_extensions.no_permissions')</h4>
                        <p>@lang('product_extensions.no_permissions_message')</p>
                    </div>
                </div>
            </div>
        @endif
