...
<section class="content">
    @component('components.widget', ['class' => 'box-primary', 'title' => __( 'business.all_your_business_locations' )])
        @slot('tool')
            <div class="box-tools">
                <a href="{{route('business-location.map')}}" class="tw-dw-btn tw-bg-gradient-to-r tw-from-green-600 tw-to-emerald-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full pull-right tw-mb-2 tw-mr-2">
                    <i class="fa fa-map-marker"></i> @lang('lang_v1.view_on_map')
                </a>
