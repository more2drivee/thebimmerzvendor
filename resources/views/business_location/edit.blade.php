            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            {!! Form::text('latitude', $location->latitude, ['class' => 'form-control', 'placeholder' => __( 'lang_v1.latitude' ), 'id' => 'latitude', 'readonly']); !!}
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            {!! Form::text('longitude', $location->longitude, ['class' => 'form-control', 'placeholder' => __( 'lang_v1.longitude' ), 'id' => 'longitude', 'readonly']); !!}
                            <span class="input-group-btn">
