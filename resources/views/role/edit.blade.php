...
<div class="row check_group">
    ...
    <div class="col-md-9">
        <div class="col-md-12">
            <div class="checkbox">
                <label>
                    {!! Form::checkbox('permissions[]', 'notification.booking', in_array('notification.booking', $role_permissions), ['class'=>'input-icheck']) !!}
                    {{ __('role.booking_notifications') }}
                </label>
            </div>
        </div>
        <div class="col-md-12">
            <div class="checkbox">
                <label>
                    {!! Form::checkbox('permissions[]', 'notification.customer', in_array('notification.customer', $role_permissions), ['class'=>'input-icheck']) !!}
                    {{ __('role.customer_notifications') }}
                </label>
            </div>
        </div>
        <div class="col-md-12">
            <div class="checkbox">
                <label>
                    {!! Form::checkbox('permissions[]', 'notification.stock', in_array('notification.stock', $role_permissions), ['class'=>'input-icheck']) !!}
                    {{ __('role.stock_notifications') }}
                </label>
            </div>
        </div>
    </div>
      ...
      <hr>
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
           ...
           <hr>
        <div class="row check_group">
               {{-- Home Page Module Permissions --}}
          <div class="row">
          <div class="col-md-3">
            <h4>@lang('home.home') @lang('user.permissions')</h4>
          </div>
          <!-- <div class="col-md-2">
            <div class="checkbox">
                <label>
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'calendar.view', in_array('calendar.view', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __('home.Calendar') }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'bookings.view', in_array('bookings.view', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __('home.Reservation') }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'essentials.todo', in_array('essentials.todo', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __('home.To-Do') }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'repair.dashboard', in_array('repair.dashboard', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __('home.Job Order') }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'contacts.view', in_array('contacts.view', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __('home.Contacts') }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'spreadsheet.sheets', in_array('spreadsheet.sheets', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __('home.Documents') }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'crm.dashboard', in_array('crm.dashboard', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __('home.CRM') }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'sell.dashboard', in_array('sell.dashboard', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __('home.Sales') }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'dashboards.dashboard', in_array('dashboards.dashboard', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __('home.Dashboards') }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'point-of-sale.dashboard', in_array('point-of-sale.dashboard', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __('home.Point of Sale') }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'payment-accounts.dashboard', in_array('payment-accounts.dashboard', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __('home.Accounting') }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'project.dashboard', in_array('project.dashboard', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __('home.Project') }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'surveys.dashboard', in_array('surveys.dashboard', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __('home.Surveys') }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'purchases.dashboard', in_array('purchases.dashboard', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __('home.Purchase') }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'products.dashboard', in_array('products.dashboard', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __('home.Inventory') }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'barcode.dashboard', in_array('barcode.dashboard', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __('home.Barcode') }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'hrm.dashboard', in_array('hrm.dashboard', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __('home.Employees') }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'settings.dashboard', in_array('settings.dashboard', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __('home.Settings') }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'artificial-intelligence.dashboard', in_array('artificial-intelligence.dashboard', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __('home.Ai') }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'time-management.dashboard', in_array('time-management.dashboard', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __('home.Time Management') }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'reports.dashboard', in_array('reports.dashboard', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __('home.Reports') }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'treasury.dashboard', in_array('treasury.dashboard', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __('home.treasury') }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'vin.dashboard', in_array('vin.dashboard', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __('home.Vin') }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'sms.dashboard', in_array('sms.dashboard', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __('home.SMS') }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'checkcar.inspections.index', in_array('checkcar.inspections.index', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __('checkcar::lang.menu_check_car') }}
                </label>
              </div>
            </div>
          </div>
        ...
        <div class="row check_group">
        <div class="col-md-1">
          <h4>@lang( 'treasury::lang.treasury' )</h4>
        </div>
        <div class="col-md-2">
            <div class="checkbox">
              <label>
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'treasury.view', in_array('treasury.view', $role_permissions),
                [ 'class' => 'input-icheck']); !!} {{ __('treasury::lang.view') }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'treasury.create', in_array('treasury.create', $role_permissions),
                [ 'class' => 'input-icheck']); !!} {{ __('treasury::lang.create') }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'treasury.delete', in_array('treasury.delete', $role_permissions),
                [ 'class' => 'input-icheck']); !!} {{ __('treasury::lang.delete') }}
              </label>
            </div>
          </div>
        </div>
