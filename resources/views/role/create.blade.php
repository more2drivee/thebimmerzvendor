...
<div class="row check_group">
    ...
    <div class="col-md-9">
        ...
        <div class="col-md-12">
            <div class="checkbox">
                <label>
                    {!! Form::checkbox('permissions[]', 'notification.all', false, ['class' => 'input-icheck']); !!}
                    {{ __('role.notification.all') }}
                </label>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <h5>@lang('role.notification_categories.booking')</h5>
            <div class="checkbox">
                <label>
                    {!! Form::checkbox('permissions[]', 'notification.booking', false, ['class' => 'input-icheck']); !!}
                    {{ __('role.notification.booking') }}
                </label>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <h5>@lang('role.notification_categories.customer')</h5>
            <div class="checkbox">
                <label>
                    {!! Form::checkbox('permissions[]', 'notification.customer', false, ['class' => 'input-icheck']); !!}
                    {{ __('role.notification.customer') }}
                </label>
            </div>
        </div>

        {{-- Stock / Warehouse Notifications --}}
        <div class="col-md-12">
            <h5>@lang('role.notification_categories.stock')</h5>
            <div class="checkbox">
                <label>
                    {!! Form::checkbox('permissions[]', 'notification.stock', false, ['class' => 'input-icheck']); !!}
                    {{ __('role.notification.stock') }}
                </label>
            </div>
        </div>
      ...
      <div class="col-md-9">
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'calendar.view', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'bookings.view', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'essentials.todo', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'repair.dashboard', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'contacts.view', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'spreadsheet.sheets', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'crm.dashboard', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'sell.dashboard', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'dashboards.dashboard', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'point-of-sale.dashboard', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'payment-accounts.dashboard', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'project.dashboard', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'surveys.dashboard', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'purchases.dashboard', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'products.dashboard', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'barcode.dashboard', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'hrm.dashboard', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'settings.dashboard', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'artificial-intelligence.dashboard', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'time-management.dashboard', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'reports.dashboard', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'treasury.dashboard', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'vin.dashboard', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'sms.dashboard', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'checkcar.inspections.index', false, 
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'treasury.view', false,
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'treasury.create', false,
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'treasury.delete', false,
