        ...
        <div class="tw-px-5 tw-pt-3">
            ...
            <div class="custom-class">
                <div class="data_handel_view">
                    ...
                    @include('layouts.partials.site_bar')
                </div>
                        ...
                        @if ($is_admin)
                            <div class="tw-mt-2 sm:tw-w-1/3 md:tw-w-1/4 tw-text-right">
                                ...
                                <button type="button" id="dashboard_date_filter"
                                        style="background-color:#c740f9;border-radius: 15px;color:white;"
...
@endif
                        ...
                        <div class="col-md-12">
                            @component('components.static', [
                                ...
                                'svg' =>
                                    '<svg class="tw-w-6 tw-h-6" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                        <path d="M3 7l9 -4l9 4l-9 4l-9 -4v10l9 4l9 -4v-10" />
                                        <path d="M3 7l9 4l9 -4" />
                                        <path d="M12 11v10" />
                                    </svg>',
                            ])
                                <p class="tw-text-sm tw-font-medium tw-text-gray-500 tw-truncate tw-whitespace-nowrap">
                                    @lang('home.Count Of Products')
                                </p>
                                <p class="tw-mt-0.5 tw-text-gray-900 tw-text-xl tw-truncate tw-font-semibold tw-tracking-tight tw-font-mono">
                                               {{ DB::table('products')->where('enable_stock', 1)->count(); }}
                                </p>
                            @endcomponent
                        </div>
                        ...
                        <div class="col-md-12">
                            @component('components.static', [
                                ...
                                <p class="tw-text-sm tw-font-medium tw-text-gray-500 tw-truncate tw-whitespace-nowrap">
                                    @lang('home.Count Of Services')
                                </p>
                                <p class="tw-mt-0.5 tw-text-gray-900 tw-text-xl tw-truncate tw-font-semibold tw-tracking-tight tw-font-mono">
                                    {{ DB::table('products')->where('enable_stock', 0)->count(); }}
                                </p>
                            @endcomponent
                        </div>
                        ...
                        <div class="col-md-12">
                            @component('components.static', [
                                ...
                                'svg' =>
                                    '<svg class="tw-w-6 tw-h-6" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                        <path d="M3 10l1 -2a4 4 0 0 1 3 -2h10a4 4 0 0 1 3 2l1 2" />
                                        <path d="M7 14h-2a1 1 0 0 1 -1 -1v-2h3v3" />
                                        <path d="M17 14h2a1 1 0 0 0 1 -1v-2h-3v3" />
                                        <path d="M5 10h14v4a1 1 0 0 1 -1 1h-12a1 1 0 0 1 -1 -1v-4z" />
                                        <circle cx="7" cy="17" r="2" />
                                        <circle cx="17" cy="17" r="2" />
                                    </svg>',
                            ])
                                <p class="tw-text-sm tw-font-medium tw-text-gray-500 tw-truncate tw-whitespace-nowrap">
                                    {{ __('home.count_of_category_brands') }}
                                </p>
                                <p class="tw-mt-0.5 tw-text-gray-900 tw-text-xl tw-truncate tw-font-semibold tw-tracking-tight tw-font-mono">
                        ...
                        <div class="col-md-12">
                            @component('components.static', [
                                ...
                                <p class="tw-text-sm tw-font-medium tw-text-gray-500 tw-truncate tw-whitespace-nowrap">
                                    {{ __('home.count_of_compatible_models') }}
                                </p>
                                <p class="tw-mt-0.5 tw-text-gray-900 tw-text-xl tw-truncate tw-font-semibold tw-tracking-tight tw-font-mono">
                                {{   DB::table('product_compatibility')->distinct('model_id')->count('model_id'); }}                                </p>
                            @endcomponent
                        </div>
        @endif
                    </div>
                                ...
                                <div class="tw--mx-4 tw--my-2 tw-overflow-x-auto sm:tw--mx-5">
                                    <div class="tw-inline-block tw-min-w-full tw-py-2 tw-align-middle sm:tw-px-5">
                                        <table class="table table-bordered table-striped"
                                               id="purchase_payment_dues_table"
                                               style="width: 100%;">
                                            <thead>
                                            <tr>
