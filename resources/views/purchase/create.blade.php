					...
					<table class="table table-condensed table-bordered table-th-green text-center table-striped" id="purchase_entry_table">
						<thead>
							<tr>
								...
								<th>
								@lang( 'purchase.received_qty' )
								<button type="button" class="btn btn-xs btn-info sync_asked_qty" title="{{__('purchase.sync_asked_qty')}}">
...
<div class="modal fade contact_modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
	@include('contact.create', ['quick_add' => true, 'types' => ['supplier' => __('report.supplier')], 'selected_type' => 'supplier'])
</div>
