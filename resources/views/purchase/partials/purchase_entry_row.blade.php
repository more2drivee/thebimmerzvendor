@foreach( $variations as $variation)
    <tr @if(!empty($purchase_order_line)) data-purchase_order_id="{{$purchase_order_line->transaction_id}}" @endif @if(!empty($purchase_requisition_line)) data-purchase_requisition_id="{{$purchase_requisition_line->transaction_id}}" @endif>
        ...
        <td>
            {{ $product->name }}{{ $product->brand ? ' - ' . $product->brand->name : '' }} ({{$variation->sub_sku}})
        ...
        <td>
            ...
            @php
                ...
                $received_qty_value = $quantity_value;
            @endphp

            <input type="text"
                name="purchases[{{$row_count}}][asked_qty]"
                ...
                placeholder="{{__('purchase.asked_qty')}}"
            >
        </td>
        <td>
            ...
            @if(!empty($product->second_unit))
                ...
                value="{{@format_quantity($secondary_unit_quantity)}}"
