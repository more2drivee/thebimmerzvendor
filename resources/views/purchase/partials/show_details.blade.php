        ...
        <table class="table bg-gray">
          <thead>
            <tr class="bg-green">
              ...
              <th class="text-right">@lang( 'lang_v1.received_qty' )</th>
          ...
          @foreach($purchase->purchase_lines as $purchase_line)
            <tr>
              ...
              <td class="text-right">
                <span class="display_currency" data-is_quantity="true" data-currency_symbol="false">{{ $purchase_line->asked_qty ?? $purchase_line->quantity }}</span>
              </td>
