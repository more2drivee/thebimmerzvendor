      ...
      <div class="row payment_row">
        <div class="col-md-12">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <input type="checkbox" id="is_postpone" name="is_postpone">
                <strong>@lang('treasury::lang.postpone_payment')</strong>
              </label>
            </div>
          </div>
        </div>
      </div>
      <div class="row payment_row" id="postpone_date_row" style="display: none;">
        <div class="col-md-4">
          <div class="form-group">
            {!! Form::label("postpone_date" , __('treasury::lang.postpone_date') . ':*') !!}
            <div class="input-group">
              <span class="input-group-addon">
                <i class="fa fa-calendar"></i>
              </span>
              {!! Form::text('postpone_date', null, ['class' => 'form-control', 'id' => 'postpone_date']); !!}
            </div>
          </div>
        </div>
      </div>
      <div class="row payment_row" id="payment_fields_row">
        <div class="col-md-4">
          <div class="form-group">
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              {!! Form::text("amount", $payment_line->amount, ['class' => 'form-control input_number payment_amount', 'required', 'placeholder' => 'Amount', 'data-rule-max-value' => $payment_line->amount, 'data-msg-max-value' => __('lang_v1.max_amount_to_be_paid_is', ['amount' => $amount_formated])]); !!}
            </div>
          </div>
        </div>
