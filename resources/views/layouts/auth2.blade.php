    ...
    <div class="container-fluid">
        <div class="row eq-height-row">
            <div class="col-md-12 col-sm-12 col-xs-12 right-col tw-pt-20 tw-pb-10 tw-px-5">
                <div class="row">
{{--                    <div class="lg:tw-w-16 md:tw-h-16 tw-w-12 tw-h-12 tw-flex tw-items-center tw-justify-center tw-mx-auto tw-overflow-hidden tw-rounded-full tw-p-0.5 tw-mb-4">--}}
{{--                        <img src="{{ asset('/uploads/images/new_logo.png') }}" alt="lock" class="tw-rounded-full tw-object-fill tw-w-[100px]" />--}}
{{--                    </div>--}}
                    <div class=" tw-flex tw-items-center tw-justify-center tw-mx-auto " style="padding: 10px">
                        <img src="{{ asset('/uploads/images/new_logo.png') }}" alt="lock" style="width: 200px" />
                    </div>
