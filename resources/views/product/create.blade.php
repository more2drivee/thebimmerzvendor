...
<section class="content">
       ...
       <div class="col-sm-4">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="input-group" style="display: flex; flex-wrap: nowrap;">
                    {!! Form::text('sku', null, ['class' => 'form-control', 'id' => 'sku_input', 'placeholder' => __('product.sku'), 'style' => 'flex: 1;']) !!}
        ...
        <div class="col-sm-4 @if(!session('business.enable_category')) hide @endif">
            <div class="form-group">
                ...
                {!! Form::select('category_id', $categories, !empty($duplicate_product->category_id) ? $duplicate_product->category_id : null, [
        ...
        <div class="col-sm-4 @if(!(session('business.enable_category') && session('business.enable_sub_category'))) hide @endif">
            <div class="form-group">
                ...
                {!! Form::select('sub_category_id', $sub_categories, !empty($duplicate_product->sub_category_id) ? $duplicate_product->sub_category_id : null, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2', 'id' => 'sub_category_id']) !!}
            </div>
        </div>
        ...
        <div class="col-sm-4 @if(!(session('business.enable_category') && session('business.enable_sub_category') && !empty(session('business.common_settings.enable_sub_sub_category')))) hide @endif">
            <div class="form-group">
                ...
                {!! Form::select('sub_sub_category_id', $sub_sub_categories, !empty($duplicate_product->sub_sub_category_id) ? $duplicate_product->sub_sub_category_id : null, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2', 'id' => 'sub_sub_category_id']) !!}
            </div>
        </div>
        ...
        <div class="col-sm-4 @if(!(session('business.enable_category') && session('business.enable_sub_category') && !empty(session('business.common_settings.enable_sub_sub_category')))) hide @endif">
            <div class="form-group">
                ...
                {!! Form::select('sub_sub_sub_category_id', $sub_sub_sub_categories, !empty($duplicate_product->sub_sub_sub_category_id) ? $duplicate_product->sub_sub_sub_category_id : null, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2', 'id' => 'sub_sub_sub_category_id']) !!}
            </div>
        </div>
    ...
    @endphp
                            ...
                            @if(!empty($default_location))
                                <tr>
                                    <td>
                                        ...
                                        <input type="hidden" name="product_locations[]" value="{{ $default_location }}">
                                    </td>
                                    <td>
        ...
        <div class="col-sm-4 @if(!empty($duplicate_product) && $duplicate_product->enable_stock == 0) hide @endif" id="stock_location_div">
            <div class="form-group">
                {!! Form::label('stock_location', __('lang_v1.stock_location') . ':') !!} @show_tooltip(__('lang_v1.stock_location_help'))
                {!! Form::text('stock_location', !empty($duplicate_product->stock_location) ? $duplicate_product->stock_location : null, [
                    'class' => 'form-control',
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <br>
                <label>
                    {!! Form::checkbox('is_ecom', 1, !(empty($duplicate_product)) ? $duplicate_product->is_ecom : false, ['class' => 'input-icheck']) !!} <strong>E-commerce</strong>
                </label>
            </div>
        </div>


        <!-- Product Compatibility Data Table -->
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="product_compatibility_table">
                        ...
                        <tbody>
                            <!-- Compatibility rows will be added here dynamically -->
                        </tbody>
                        <tfoot>
                            <tr>
                                <td colspan="6">
  ...
  <script src="{{ asset('js/product.js?v=' . $asset_v) }}"></script>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            // Create brand category options object for use in template
...
<!-- Modal for adding new compatibility -->
<div class="modal fade" id="add_compatibility_modal" tabindex="-1" role="dialog" aria-labelledby="addCompatibilityModalLabel" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="compatibility_form" onsubmit="return false;">
                    <div class="form-group">
                        {!! Form::label('modal_brand_category_id', __('lang_v1.brand_category') . ':*') !!}
                        {!! Form::select('modal_brand_category_id', $brand_category, null, [
                            'class' => 'form-control',
                            'required',
                            'id' => 'modal_brand_category_id',
                            'style' => 'display: none;'
                        ]) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('modal_model_id', [], null, [
                            'class' => 'form-control',
                            'required',
                            'id' => 'modal_model_id',
                            'style' => 'display: none;'
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::number('modal_from_year', null, [
                            'class' => 'form-control',
                            'required',
                            'placeholder' => __('lang_v1.from_year'),
                            'min' => '1900',
                            'max' => date('Y'),
                            'id' => 'modal_from_year'
                        ]) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::number('modal_to_year', null, [
                            'class' => 'form-control',
                            'required',
                            'placeholder' => __('lang_v1.to_year'),
                            'min' => '1900',
                            'max' => date('Y'),
                            'id' => 'modal_to_year'
                        ]) !!}
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="add_compatibility_btn">@lang('messages.add')</button>
            </div>
        </div>
    </div>
</div>

<!-- Modal for editing compatibility -->
<div class="modal fade" id="edit_compatibility_modal" tabindex="-1" role="dialog" aria-labelledby="editCompatibilityModalLabel" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-body">
                <form id="edit_compatibility_form" onsubmit="return false;">
                    <input type="hidden" id="edit_row_index" value="">
                    <div class="form-group">
                        {!! Form::label('edit_modal_brand_category_id', __('lang_v1.brand_category') . ':*') !!}
                        {!! Form::select('edit_modal_brand_category_id', $brand_category, null, [
                            'class' => 'form-control',
                            'required',
                            'id' => 'edit_modal_brand_category_id',
                            'style' => 'display: none;'
                        ]) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('edit_modal_model_id', [], null, [
                            'class' => 'form-control',
                            'required',
                            'id' => 'edit_modal_model_id',
                            'style' => 'display: none;'
                        ]) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::number('edit_modal_from_year', null, [
                            'class' => 'form-control',
                            'required',
                            'placeholder' => __('lang_v1.from_year'),
                            'min' => '1900',
                            'max' => date('Y'),
                            'id' => 'edit_modal_from_year'
                        ]) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('edit_modal_to_year', __('lang_v1.to_year') . ':*') !!}
                        {!! Form::number('edit_modal_to_year', null, [
                            'class' => 'form-control',
                            'required',
                            'placeholder' => __('lang_v1.to_year'),
                            'min' => '1900',
                            'max' => date('Y'),
                            'id' => 'edit_modal_to_year'
                        ]) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('edit_modal_motor_cc', 'Motor CC:') !!}
                        {!! Form::text('edit_modal_motor_cc', null, [
                            'class' => 'form-control',
                            'placeholder' => 'e.g. 1600',
                            'id' => 'edit_modal_motor_cc'
                        ]) !!}
                    </div>
                </form>
            </div>
