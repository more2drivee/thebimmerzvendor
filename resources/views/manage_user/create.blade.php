...
{!! Form::open(['url' => action([\App\Http\Controllers\ManageUserController::class, 'store']), 'method' => 'post', 'id' => 'user_add_form' ]) !!}
      ...
      <div class="col-md-5">
        <div class="form-group">
          {!! Form::label('first_name', __( 'business.first_name' ) . ':*') !!}
            {!! Form::text('first_name', null, ['class' => 'form-control',  'placeholder' => __( 'business.first_name' ) ]); !!}
        </div>
      </div>
      <div class="col-md-5">
        <div class="form-group">
  ...
  <div class="col-md-12">
    @component('components.widget', ['title' => __('lang_v1.primary_work_location')])
      <div class="col-md-6">
        <div class="form-group">
          {!! Form::label('location_id', __( 'lang_v1.primary_work_location' ) . ':') !!} @show_tooltip(__('lang_v1.tooltip_primary_work_location'))
            <select name="user_location_id" id="location_id" class="form-control" style="width: 100%;">
