<div class="modal-dialog" role="document">
    <div class="modal-content">
        <form method="post" action="{{action([\App\Http\Controllers\LabourByVehicleController::class, 'storeLabourProduct'])}}" id="labour_product_form">
            @csrf
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
                <h4 class="modal-title" id="gridSystemModalLabel">@lang('Add Labour Product')</h4>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="labour_product_name" name="name" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="labour_product_sku" name="sku">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <small class="text-muted">
                            ...
                            @lang('Note: Labour products will be created with stock management disabled and marked as labour items.')
                        </small>
                    </div>
                </div>
            </div>
