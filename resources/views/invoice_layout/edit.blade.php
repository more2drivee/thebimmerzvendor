      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('common_settings[show_brand_with_product]', 1, !empty($invoice_layout->common_settings['show_brand_with_product']), ['class' => 'input-icheck']); !!} Show Brand with Product Name</label>
              </div>
            </div>
          </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('common_settings[carservpro_show_category]', 1, !empty($invoice_layout->common_settings['carservpro_show_category']), ['class' => 'input-icheck']); !!} Show category column (CarServPro)</label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('common_settings[carservpro_category_as_row]', 1, !empty($invoice_layout->common_settings['carservpro_category_as_row']), ['class' => 'input-icheck']); !!} Show category as header row (CarServPro)</label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('common_settings[carservpro_separate_parts_services]', 1, !empty($invoice_layout->common_settings['carservpro_separate_parts_services']), ['class' => 'input-icheck']); !!} Separate spare parts and services (CarServPro)</label>
              </div>
          </div>
        </div>
        </div>
