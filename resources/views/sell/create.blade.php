...
<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
				...
				@if(in_array('types_of_service', $enabled_modules) && !empty($types_of_service))
					<div class="col-md-4 col-sm-6">
						<div class="form-group">
							<div class="input-group">
								<span class="input-group-addon">
									<i class="fa fa-external-link-square-alt text-primary "></i>
								</span>
								{!! Form::select('types_of_service_id', $types_of_service, null, ['class' => 'form-control', 'id' => 'types_of_service', 'style' => 'width: 100%;', 'placeholder' => __('lang_v1.select_types_of_service')]); !!}
			...
			@endcomponent
			@component('components.widget', ['class' => 'box-solid d-none'])
			<div class="col-md-4">
				<div class="form-group">
...
<!-- Vehicle modal -->
<div class="modal fade" id="add_vehicle_modal" tabindex="-1" role="dialog" aria-labelledby="addVehicleModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form id="add_vehicle_form" action="{{ route('vehicles.store_car_data') }}" method="POST" novalidate>
                @csrf
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    <h4 class="modal-title" style="width:100%; text-align: center;">@lang('lang_v1.add_vehicle')</h4>
                </div>
                <div class="modal-body">
                    <input type="hidden" name="contact_id" id="vehicle_contact_id">
                    <div class="row">
                        <!-- Brand -->
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="category_id">@lang('lang_v1.brand'):</label>
                                <div class="input-group custom-input-group d-flex align-items-center flex-nowrap">
                                    ...
                                    <select id="category_id" name="category_id" class="form-control select2" required>
                                        <option value="">@lang('lang_v1.select_brand')</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="model_id">@lang('lang_v1.model'):</label>
                                <div class="input-group custom-input-group d-flex align-items-center flex-nowrap">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                            <i class="fa fa-car"></i>
                                    ...
                                    <select id="model_id" name="model_id" class="form-control select2" required>
                                        <option value="">@lang('lang_v1.select_model')</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="manufacturing_year">@lang('lang_v1.year'):</label>
                                <div class="input-group custom-input-group d-flex align-items-center flex-nowrap">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                            <i class="fa fa-calendar"></i>
                                    ...
                                    <select class="form-control" id="manufacturing_year" name="manufacturing_year" required>
                                        <option value="">@lang('lang_v1.select_year')</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="car_type">@lang('lang_v1.car_type'):</label>
                                <div class="input-group custom-input-group d-flex align-items-center flex-nowrap">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                            <i class="fa fa-car"></i>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="plate_number">@lang('lang_v1.plate_number'):</label>
                                <div class="input-group custom-input-group d-flex align-items-center flex-nowrap">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                    ...
                                    <input type="text" class="form-control" id="plate_number" name="plate_number" placeholder="@lang('lang_v1.plate_number')">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="chassis_number">@lang('lang_v1.vin_number'):</label>
                                <div class="input-group custom-input-group d-flex align-items-center flex-nowrap">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                            <i class="fa fa-key"></i>
                                    ...
                                    <input type="text" class="form-control" id="chassis_number" name="chassis_number" placeholder="@lang('lang_v1.enter_vin_number')" maxlength="17">
                                </div>
                                <small class="text-muted">@lang('lang_v1.enter_vin_17_characters')</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="color">@lang('lang_v1.color'):</label>
                                <div class="input-group custom-input-group d-flex align-items-center flex-nowrap">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                    ...
                                    <input type="text" class="form-control" id="color" name="color" placeholder="@lang('lang_v1.color')">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="save_vehicle_btn">@lang('messages.save')</button>
                </div>
            </form>
        </div>
    </div>
...
@section('javascript')
    ...
    <!-- Custom CSS for Vehicle Modal - Matching create_models.blade.php styling -->
    <style>
        /* Custom input group styles from create_models.blade.php */
        ...
        /* Vehicle modal specific styling */
        #add_vehicle_modal .modal-dialog {
            margin-top: 50px;
        }

        #add_vehicle_modal .modal-content {
            border-radius: 6px;
            box-shadow: 0 2px 3px rgba(0, 0, 0, 0.125);
        }

        #add_vehicle_modal .modal-header {
            border-bottom-color: #f4f4f4;
            background-color: #f9f9f9;
        }

        #add_vehicle_modal .modal-footer {
            border-top-color: #f4f4f4;
            background-color: #f9f9f9;
        }

        /* Ensure proper z-index for vehicle modal */
        #add_vehicle_modal {
            z-index: 1060 !important;
        }

        /* Fix select2 dropdown width in vehicle modal */
        #add_vehicle_modal .select2-container {
            width: 100% !important;
            min-width: 200px !important;
        }

        #add_vehicle_modal .select2-selection {
            width: 100% !important;
            min-width: 200px !important;
        ...
        #add_vehicle_modal .select2-selection__rendered {
            line-height: 32px !important;
            padding-left: 8px !important;
        }

        #add_vehicle_modal .select2-selection__arrow {
            height: 32px !important;
        }

        /* Ensure input group with select2 maintains proper width */
        #add_vehicle_modal .custom-input-group .select2-container {
            flex: 1 !important;
        }
    </style>
    ...
    <script type="text/javascript">
    	$(document).ready(function() {
            ...
            $('#add_vehicle_modal .select2').select2({
                dropdownParent: $('#add_vehicle_modal')
            });
            ...
            function loadCustomerVehicles(customerId) {
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        console.error('Error loading customer vehicles:', xhr);
            ...
            // Handle vehicle selection to show vehicle details
            // $('#contact_device_id').on('change', function() {
            //     var vehicleId = $(this).val();
            //     // var $vehicleDetailsDiv = $('#vehicle_details_div');

            //     if (!vehicleId) {
            //         $vehicleDetailsDiv.empty();
            //         return;
            //     }

            //     // Get vehicle details from the selected option text
            //     var selectedText = $(this).find('option:selected').text();
            //     if (selectedText && selectedText !== '@lang("messages.please_select")') {
            //         $vehicleDetailsDiv.html('<small class="text-muted"><i class="fa fa-car"></i> ' + selectedText + '</small>');
            //     }
            // });

            // Load vehicles on page load if customer is pre-selected
            // Use setTimeout to ensure Select2 is fully initialized
            setTimeout(function() {
                var preSelectedCustomerId = $('#customer_id').val();
                if (preSelectedCustomerId) {
                    console.log('Pre-selected customer found:', preSelectedCustomerId);
                    loadCustomerVehicles(preSelectedCustomerId);
                }
            }, 500);

            // Also listen for Select2 events in case customer is loaded via AJAX
            $('#customer_id').on('select2:select', function(e) {
                var customerId = e.params.data.id;
                console.log('Customer selected via Select2:', customerId);
                loadCustomerVehicles(customerId);
            });

            $('#customer_id').on('select2:clear', function(e) {
                console.log('Customer cleared via Select2');
            ...
            // Add default option
            $yearDropdown.append('<option value="">@lang("lang_v1.select_year")</option>');
            ...
            $('#add_vehicle_btn').click(function() {
                ...
                $('#vehicle_contact_id').val(contactId);
                
                // Load brands dropdown
                $.ajax({
                    url: '/bookings/get-brands',
                    type: 'GET',
                    success: function(response) {
                        var options = '<option value="">@lang("lang_v1.select_brand")</option>';
                    ...
                    error: function(xhr) {
                        toastr.error('Error loading brands');
                    }
                });
            ...
            // Handle brand selection to load models
            $('#category_id').on('change', function() {
                var brandId = $(this).val();
                var $modelDropdown = $('#model_id');
                
                // Reset model dropdown
                $modelDropdown.html('<option value="">@lang("lang_v1.select_model")</option>');
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.message) {
                            ...
                            $('#category_id, #model_id').val('').trigger('change');
                            
                            // Refresh the vehicles dropdown using our reusable function
                    ...
                    error: function(xhr) {
                        toastr.error(xhr.responseJSON.message || 'Error saving vehicle data');
                    }
                });
            });
