			    ...
			    <div class="col-md-4">
			        <div class="form-group">
			            ...
			            <div class="input-group">
			                ...
			                {!! Form::text('shipping_charges', !empty($transaction->shipping_charges) ? num_format($transaction->shipping_charges) : '', ['class' => 'form-control input_number', 'placeholder' => __('sale.shipping_charges')]); !!}
			            </div>
			        </div>
			    </div>
