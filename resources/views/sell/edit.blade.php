            ...
            <div class="col-md-12 col-sm-12">
                @component('components.widget', ['class' => 'box-solid'])
                    ...
                    @if ($transaction->job_id)
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                {!! Form::text('created_by', $transaction->created_by ?? '', [
                                    'class' => 'form-control',
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                {!! Form::label('job_sheet_no', __('Job Sheet No') . ':') !!}
                                {!! Form::text('job_sheet_no', $transaction->job_sheet_no ?? '', [
                                    'class' => 'form-control',
                                    'placeholder' => __('Job Sheet No'),
                                    'readonly',
                                ]) !!}
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                {!! Form::label('car_model', __('Car Model') . ':') !!}
                                {!! Form::text('car_model', $transaction->car_model ?? '', [
                                    'class' => 'form-control',
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                {!! Form::label('car_brand', __('Car Brand') . ':') !!}
                                {!! Form::text('car_brand', $transaction->car_brand ?? '', [
                                    'class' => 'form-control',
                                    'placeholder' => __('Car Brand'),
                                    'readonly',
                                ]) !!}
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                {!! Form::label('car_vin', __('Car VIN') . ':') !!}
                                {!! Form::text('car_vin', $transaction->car_vin ?? '', [
                                    'class' => 'form-control',
                                    'placeholder' => __('Car VIN'),
                                    'readonly',
                                ]) !!}
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                {!! Form::label('car_color', __('Car Color') . ':') !!}
                                {!! Form::text('car_color', $transaction->car_color ?? '', [
                                    'class' => 'form-control',
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                {!! Form::label('contact_phone', __('Contact Phone') . ':') !!}
                                {!! Form::text('contact_phone', $transaction->contact_phone ?? '', [
                                    'class' => 'form-control',
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                {!! Form::label('km', __('KM') . ':') !!}
                                {!! Form::text('km', $transaction->km ?? '', ['class' => 'form-control', 'placeholder' => __('KM')]) !!}
                            </div>
                        </div>

                        <div class="col-sm-3">
                            <div class="form-group">
                                {!! Form::label('plate_number', __('Plate Number') . ':') !!}
                                {!! Form::text('plate_number', $transaction->plate_number ?? '', [
                                    'class' => 'form-control',
                                    'placeholder' => __('Plate Number'),
                                    'readonly',
                                ]) !!}
                            </div>
                        </div>
		        	...
		        	<span id="restaurant_module_span" 
		        		data-transaction_id="{{$transaction->created_by}}">
		        	</span>
		        @endif --}}
                @endcomponent
                ...
                @component('components.widget', ['class' => 'box-solid'])
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!!Form::text('shipping_charges', @num_format($transaction->shipping_charges ?? 0),['class'=>'form-control input_number','placeholder'=> __('sale.shipping_charges')]);!!}
                            </div>
                        </div>
                    </div>
                    @php
                    ...
                    @if(!empty($shipping_custom_label_1))
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('shipping_custom_field_1', $transaction->shipping_custom_field_1, ['class' => 'form-control','placeholder' => $shipping_custom_label_1, 'required' => $is_shipping_custom_field_1_required]); !!}
                            </div>
                        </div>
                    @endif
                    @if(!empty($shipping_custom_label_2))
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('shipping_custom_field_2', $transaction->shipping_custom_field_2, ['class' => 'form-control','placeholder' => $shipping_custom_label_2, 'required' => $is_shipping_custom_field_2_required]); !!}
                            </div>
                        </div>
                    @endif
                    @if(!empty($shipping_custom_label_3))
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('shipping_custom_field_3', $transaction->shipping_custom_field_3, ['class' => 'form-control','placeholder' => $shipping_custom_label_3, 'required' => $is_shipping_custom_field_3_required]); !!}
                            </div>
                        </div>
                    @endif
                    @if(!empty($shipping_custom_label_4))
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('shipping_custom_field_4', $transaction->shipping_custom_field_4, ['class' => 'form-control','placeholder' => $shipping_custom_label_4, 'required' => $is_shipping_custom_field_4_required]); !!}
                            </div>
                        </div>
                    @endif
                    @if(!empty($shipping_custom_label_5))
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('shipping_custom_field_5', $transaction->shipping_custom_field_5, ['class' => 'form-control','placeholder' => $shipping_custom_label_5, 'required' => $is_shipping_custom_field_5_required]); !!}
                            </div>
                        </div>
                    @endif
                @endcomponent
            ...
            @can('sell.payments')
                @component('components.widget', ['class' => 'box-solid', 'title' => __('purchase.add_payment')])
                    ...
                    <div class="row @if ($change_return['amount'] == 0) hide @endif payment_row" id="change_return_payment_data">
                        ...
                        <?php $checked = DB::table('transactions')->where('id', $id_for_exit)->select('Exit_permission')->first();
                        $checkedStatus = $checked->Exit_permission == 'Exited' || $checked->Exit_permission == 'Exit allowed' ? 'checked' : '';
                        ?>
                        <div style="text-align: center; font-size: 25px">
                            <input type="checkbox" id="exitCheckbox_<?php echo $id_for_exit; ?>"
                                onchange="updateVehicleStatus(<?php echo $id_for_exit; ?>, this.checked)" <?php echo $checkedStatus; ?>>
                            <label for="exitCheckbox_<?php echo $id_for_exit; ?>">Exit Permission</label>
                        </div>
...
@section('javascript')
    ...
    <script type="text/javascript">
        function updateVehicleStatus(id, isChecked) {
            let confirmMessage = isChecked ? "Mark this vehicle as exited?" : "Undo exit status?";
            if (!confirm(confirmMessage)) {
                document.getElementById("exitCheckbox_" + id).checked = !isChecked; // Revert checkbox state
                return;
            }
            ...
            fetch('/update-vehicle-status', {
                ...
                .then(data => {
                    if (!data.success) {
                        ...
                        document.getElementById("exitCheckbox_" + id).checked = !isChecked; // Revert on failure
                    }
                })
                .catch(error => {
                    console.error('Error:', error);
                    document.getElementById("exitCheckbox_" + id).checked = !isChecked; // Revert on error
                });
        }
