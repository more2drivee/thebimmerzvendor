  ...
  @endphp
    ...
    <div class="modal-body">
      ...
      <div class="row">
        ...
        <div class="col-md-4 supplier_login_fields" @if($contact->type !== 'supplier' && $contact->type !== 'both') style="display: none;" @endif>
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::text('username', $contact->username, ['class' => 'form-control', 'placeholder' => __('lang_v1.username')]) !!}
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 supplier_login_fields" @if($contact->type !== 'supplier' && $contact->type !== 'both') style="display: none;" @endif>
            <div class="form-group">
                ...
                <small class="text-muted">@lang('lang_v1.leave_empty_to_keep_current_password')</small>
            </div>
        </div>
        ...
        @if(!isset($update_action) && !isset($quick_add))
        <div class="col-md-4">
          <div class="form-group">
...
$(document).ready(function() {
    ...
    $('#contact_type').on('change', function() {
        ...
        if (selectedType === 'supplier' || selectedType === 'both') {
            ...
            // Make username and password required for suppliers
            $('input[name="username"]').attr('required', 'required');
        } else {
            $('.supplier_login_fields').hide();
            // Remove required attribute for non-suppliers
