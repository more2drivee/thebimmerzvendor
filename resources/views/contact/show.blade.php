        ...
        <div class="row">
            <div class="col-md-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs nav-justified">
                            ...
                            @else
                                '' @endif">
                                    <a href="#reward_point_tab" data-toggle="tab" aria-expanded="true"><i
                                            class="fas fa-gift" aria-hidden="true"></i>
                        ...
                        <div class="eedit">
                            ...
                            @else
                                ...
                                <a href="#activities_tab" data-toggle="tab" aria-expanded="true"><i
                                        class="fas fa-pen-square" aria-hidden="true"></i> @lang('lang_v1.activities')</a>
                            </li>
                        </div>
                        ...
                        <div class="eedit">
                            <li
                                class="
                            @if (!empty($view_type) && $view_type == 'cars') active
                            @else
                                '' @endif">
                                <a href="#cars_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-pen-square"
                                        aria-hidden="true"></i> @lang('car.view')</a>
                            </li>
                        </div>
                        ...
                        <div class="eedit">
                            <li
                                class="
                            @if (!empty($view_type) && $view_type == 'job') active
                            @else
                                '' @endif">
                                <a href="#jobs_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-pen-square"
                                        aria-hidden="true"></i> @lang('car.job')</a>
                            </li>
                        </div>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="cars_tab">
                        @include('contact.partials.contact_vehicle_tab', ['id' => $contact->id])

                    </div>

                    <div class="tab-pane" id="jobs_tab">
                        @include('contact.partials.contact_jobs_tab', ['id' => $contact->id])
