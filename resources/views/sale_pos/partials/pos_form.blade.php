...
<div class="row">
	...
	<div class="col-md-4 col-sm-6">
		<div class="form-group">
			{!! Form::label('repair_device_id', __('repair::lang.customer_vehicle') . ':') !!}
			<div class="input-group">
				<span class="input-group-addon">
					<i class="fa fa-car"></i>
				</span>
				<select id="repair_device_id" name="repair_device_id" class="form-control select2" style="width:100%">
