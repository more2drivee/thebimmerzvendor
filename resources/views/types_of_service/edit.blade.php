<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="form-group col-md-12">
        {!! Form::label('location_price_group', __('sale.location') . ':') !!}
        {!! Form::select('location_price_group[]', $locations, $selected_locations, ['class' => 'form-control select2', 'multiple' => true, 'style' => 'width: 100%;', 'data-placeholder' => __('messages.please_select')]); !!}
      </div>
      ...
      <div class="form-group col-md-12">
          <div class="checkbox">
            <label>
               {!! Form::checkbox('is_inspection_service', 1, !empty($type_of_service->is_inspection_service)); !!} @lang( 'lang_v1.inspection_service' )
            </label>
          </div>
      </div>
      </div>
