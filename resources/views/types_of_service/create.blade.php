  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="form-group col-md-12">
        ...
        {!! Form::select('location_price_group[]', $locations, null, ['class' => 'form-control select2', 'multiple' => true, 'style' => 'width: 100%;', 'data-placeholder' => __('messages.please_select')]); !!}
      </div>
      ...
      <div class="form-group col-md-12">
          <div class="checkbox">
            <label>
               {!! Form::checkbox('is_inspection_service', 1, false); !!} @lang( 'lang_v1.inspection_service' )
            </label>
          </div>
      </div>
      </div>
