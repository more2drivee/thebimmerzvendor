...
@section('content')
    ...
    'class' => 'box-primary',
    'header' => '<h4 class="text-center">Demo Shops <small><i> <br/>Demos are for example purpose only, this application <u>can be used in many other similar businesses.</u></i> <br/><b>Click button to login that business</b></small></h4>',
])
    ...
    <style>
        * {
        ...
        @media (max-width: 768px) {
            ...
            .left-half {
                height: 15vh;
                /* Short height for the left side */
            }

            .right-half {
                flex: 1;
                /* Takes remaining space, ensuring it’s taller */
                display: flex;
                align-items: center;
                justify-content: center;
                padding: 20px;
            ...
            .img-container img {
                display: none;
                /* Optional: hide background image */
            }
        ...
        @media (max-width: 480px) {
            .left-half {
                height: 10vh;
                /* Even shorter for smaller screens */
            }
...
<body>
    <!-- Left Half - Image and Title -->
    <div class="left-half">
        <div class="img-container">
            <img src="https://images.pexels.com/photos/3354647/pexels-photo-3354647.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                alt="Car Service">
            <div class="img-overlay"></div>
        </div>
        <div class="overlay-text">
            <img src="{{ asset('/uploads/images/new_logo.png') }}" alt="CarServPro Logo" class="logo">
        </div>
    </div>
    ...
    <div class="right-half">
        <div class="login-container">
            ...
            <div class="form-container">
                <form method="POST" action="{{ route('storeAccount') }}" id="login-form">
                    {{ csrf_field() }}
