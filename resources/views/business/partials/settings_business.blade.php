<div class="pos-tab-content active">
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('jobsheet_image', 'Job Sheet Image:') !!}
                    {!! Form::file('jobsheet_image', ['accept' => 'image/*']); !!}
                    <p class="help-block"><i>Upload an image to be displayed on job sheets and canva</i></p>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                {!! Form::label('common_settings[about_us]', 'About Us:') !!}
                {!! Form::textarea('common_settings[about_us]', $common_settings['about_us'] ?? '', ['class' => 'form-control', 'rows' => 5, 'placeholder' => 'Enter business description...']); !!}
            </div>
        </div>
    </div>
</div>