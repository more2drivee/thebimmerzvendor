<div class="pos-tab-content">
    ...
    <div class="row">
        ...
        <div class="col-sm-4 enable_sub_sub_category @if($business->enable_sub_category != 1) hide @endif">
            <div class="form-group">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('common_settings[enable_sub_sub_category]', 1, !empty($common_settings['enable_sub_sub_category']) ? true : false, [ 'class' => 'input-icheck', 'id' => 'enable_sub_sub_category']); !!} {{ __( 'lang_v1.enable_sub_sub_category' ) }}
                  </label>
                </div>
            </div>
        </div>
