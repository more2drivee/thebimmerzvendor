<div class="pos-tab-content">
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('common_settings[default_shipping_charges]', __('lang_v1.default_shipping_charges') . ':') !!}
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-truck"></i>
                    </span>
                    {!! Form::text('common_settings[default_shipping_charges]', $business->common_settings['default_shipping_charges'] ?? '', ['class' => 'form-control input_number', 'placeholder' => '0.00']); !!}
                </div>
            </div>
        </div>
