    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                ...
                {!! Form::text('version_settings[latest_version_name]', $version_settings['latest_version_name'] ?? '',
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <div class="checkbox">
                    <label>
                        {!! Form::checkbox('version_settings[force_update]', 1, $version_settings['force_update'] ?? false,
                        ['class' => 'input-icheck']); !!} {{ __('lang_v1.force_update_help') }}
                    </label>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                ...
                {!! Form::text('version_settings[apk_url]', $version_settings['apk_url'] ?? '',
                    ['class' => 'form-control', 'placeholder' => '']); !!}
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                ...
                {!! Form::textarea('version_settings[message]', $version_settings['message'] ?? '',
