<div class="pos-tab-content">
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('custom_payment_11_label', __('lang_v1.custom_payment', ['number' => 11])); !!}
                {!! Form::text('custom_labels[payments][custom_pay_11]', !empty($custom_labels['payments']['custom_pay_11']) ? $custom_labels['payments']['custom_pay_11'] : null,
                ['class' => 'form-control', 'id' => 'custom_payment_11']); !!}
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('custom_payment_12_label', __('lang_v1.custom_payment', ['number' => 12])); !!}
                {!! Form::text('custom_labels[payments][custom_pay_12]', !empty($custom_labels['payments']['custom_pay_12']) ? $custom_labels['payments']['custom_pay_12'] : null,
                ['class' => 'form-control', 'id' => 'custom_payment_12']); !!}
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('custom_payment_13_label', __('lang_v1.custom_payment', ['number' => 13])); !!}
                {!! Form::text('custom_labels[payments][custom_pay_13]', !empty($custom_labels['payments']['custom_pay_13']) ? $custom_labels['payments']['custom_pay_13'] : null,
                ['class' => 'form-control', 'id' => 'custom_payment_13']); !!}
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('custom_payment_14_label', __('lang_v1.custom_payment', ['number' => 14])); !!}
                {!! Form::text('custom_labels[payments][custom_pay_14]', !empty($custom_labels['payments']['custom_pay_14']) ? $custom_labels['payments']['custom_pay_14'] : null,
                ['class' => 'form-control', 'id' => 'custom_payment_14']); !!}
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('custom_payment_15_label', __('lang_v1.custom_payment', ['number' => 15])); !!}
                {!! Form::text('custom_labels[payments][custom_pay_15]', !empty($custom_labels['payments']['custom_pay_15']) ? $custom_labels['payments']['custom_pay_15'] : null,
                ['class' => 'form-control', 'id' => 'custom_payment_15']); !!}
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('custom_payment_16_label', __('lang_v1.custom_payment', ['number' => 16])); !!}
                {!! Form::text('custom_labels[payments][custom_pay_16]', !empty($custom_labels['payments']['custom_pay_16']) ? $custom_labels['payments']['custom_pay_16'] : null,
                ['class' => 'form-control', 'id' => 'custom_payment_16']); !!}
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('custom_payment_17_label', __('lang_v1.custom_payment', ['number' => 17])); !!}
                {!! Form::text('custom_labels[payments][custom_pay_17]', !empty($custom_labels['payments']['custom_pay_17']) ? $custom_labels['payments']['custom_pay_17'] : null,
                ['class' => 'form-control', 'id' => 'custom_payment_17']); !!}
            </div>
        </div>
        <div class="clearfix"></div>
        <div class="col-sm-12">
